...
public abstract class UnitGameObject {
	private Image image;
	private int x;
	private int y;
	private int width;
  ...
  /*
	 ...
	 */
	public abstract void draw (Graphics g, ImageObserver container)
	{
	 ...
	 * Draw with default size
	 */
	public abstract void drawBig (Graphics g, ImageObserver container)
	{
